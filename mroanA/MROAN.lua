...
file:close()
sleep(1)
os.execute(' screen -S mroan ./mroan')
end
...
if not database:get('bot:rep:mute'..msg.chat_id_) then
				mroan = "<b>  ﻭ୭ ؏ـليكـمہ آلـسـ﴿﴾ـلآمہ ﻭ୭رحــمة اللّــھہّ˛❥ ٰﻭ୭بـرڪاته</b>"
else 
                mroan = ''  
end
send(msg.chat_id_, msg.id_, 1, mroan, 1, 'html')
end
if text ==   'هلاو'   then 
if not database:get('bot:rep:mute'..msg.chat_id_) then
				mroan = "<b> هـِّـ﴿💜﴾ـلاواتہ 💭🙋 ؏ـيـﻭ୭نـــًّ‏ِـِّـي نــ💡ـﻭ୭رت♩ </b>"
else 
                mroan = ''  
end
send(msg.chat_id_, msg.id_, 1, mroan, 1, 'html')
...
if text ==   'شلونك'   then 
if not database:get('bot:rep:mute'..msg.chat_id_) then
				mroan = "<b>  تُمـ😌﴾ـُُ℘ـامُُہٰ &ٰ آٳنـہتۦ ֆ. شَـşђɭǫǫŋeķـلُوٍنّگٍ ••»؟</b>"
else 
                mroan = ''  
end
send(msg.chat_id_, msg.id_, 1, mroan, 1, 'html')
...
if text ==   'شلونج'   then 
if not database:get('bot:rep:mute'..msg.chat_id_) then
				mroan = "<b> تمـُ﴿😌﴾ـُُ℘ـامُُہٰ &ٰ آٳنـہتۦ ֆ. شَـşђɭǫǫŋeķـلُوٍنّگٍ ••»؟ </b>"
else 
                mroan = ''  
end
send(msg.chat_id_, msg.id_, 1, mroan, 1, 'html')
...
if text ==   'شلونكم'   then 
if not database:get('bot:rep:mute'..msg.chat_id_) then
				mroan = "<b> مـُُ﴿😌﴾ـُُ℘ـامُُہٰ &ٰ آٳنـہتۦ ֆ. شَـşђɭǫǫŋeķـلُوٍنّگٍ ••»؟ </b>"
else 
                mroan = ''  
end
send(msg.chat_id_, msg.id_, 1, mroan, 1, 'html')
...
if text ==   'اكرهك'   then 
if not database:get('bot:rep:mute'..msg.chat_id_) then
				mroan = "<b>مـⴅỹــي تـtoـو. & آٌنـ﴿ّℳέ﴾ـّي امـ℘ـوت ؏ـليـك/ﺞ✟♩🍃</b>"
else 
                mroan = ''  
end
send(msg.chat_id_, msg.id_, 1, mroan, 1, 'html')
...
if not database:get('bot:rep:mute'..msg.chat_id_) then
				mroan = "<b>  دوه୭ ومـــہٰ۪ الضـحڪٰ۪هــہ↵🌸💛››</b>"
else 
                mroan = ''  
end
send(msg.chat_id_, msg.id_, 1, mroan, 1, 'html')
...
if text ==   'صباحو'   then 
if not database:get('bot:rep:mute'..msg.chat_id_) then
				mroan = "<b> صبـٰٖـٰٖ‏ـٳاٲඋ ٰۦٳٲلـِخٰٖـٰٖـ๋͜ـِـيرات يـرﻭ୭حـي ٰۦ˛⁽˛⁽😻💗₎⇣ </b>"
else 
                mroan = ''  
end
send(msg.chat_id_, msg.id_, 1, mroan, 1, 'html')
...
if text ==   '🌚'   then 
if not database:get('bot:rep:mute'..msg.chat_id_) then
				mroan = "<b> مۢنٰـۛмєnoـٰوٰﯟ ر ֆ‘ ٳصہخہام الجہدر 🌚🍃 </b>"
else 
                mroan = ''  
end
send(msg.chat_id_, msg.id_, 1, mroan, 1, 'html')
...
if not database:get('bot:rep:mute'..msg.chat_id_) then
				mroan = "<b> غـﹻۧ͡℘ـٌيـٰٖــٰٖرڰ ٴ بۛالګلب مہآڪہﯛ ⇣  يرۣﯢζـي </b>"
else 
                mroan = ''  
end
send(msg.chat_id_, msg.id_, 1, mroan, 1, 'html')
...
if text ==   '😁'   then 
if not database:get('bot:rep:mute'..msg.chat_id_) then
				mroan = "<b> بـ👁ـا؏ الـسـنون جنــৡـهن دگم </b>"
else 
                mroan = ''  
end
send(msg.chat_id_, msg.id_, 1, mroan, 1, 'html')
...
if text ==   '😁😁'   then 
if not database:get('bot:rep:mute'..msg.chat_id_) then
				mroan = "<b> بـ👁ـا؏ الـسـنون جنـ‏ـৡـهن دگم </b>"
else 
                mroan = ''  
end
send(msg.chat_id_, msg.id_, 1, mroan, 1, 'html')
...
if text ==   'بوت'   then 
if not database:get('bot:rep:mute'..msg.chat_id_) then
				mroan = "<b> عـٰٰـٰود لوتُٰي 🙀 يـٰگول بُِوت عبالـٰه طافٰـُٰي💔 ويضِٰل يمٰـٓسلت وينشٰٰر روابـٰٓط 😳🍃 </b>"
else 
                mroan = ''  
end
send(msg.chat_id_, msg.id_, 1, mroan, 1, 'html')
...
if text ==   'اتفل'   then 
if not database:get('bot:rep:mute'..msg.chat_id_) then
				mroan = "<b> خخـ﴿😚﴾ـخ تـ﴿💦﴾ـفوو خخـ﴿😚﴾ـخ تـ﴿💦﴾ـفوو خہــ💦ــخــ💦ـــــہٰٰخ تٌـٌـٌـٌ﴿💦﴾ـٌـٌـٌـٌف✟خــ😚ــخــ😚ـخ تــ💦ــفــ💦ــوو خخخخــووــووــووــوو💦💨😚تفــووــو😹😹 </b>"
else 
                mroan = ''  
end
send(msg.chat_id_, msg.id_, 1, mroan, 1, 'html')
...
if text ==   'هدى'   then 
if not database:get('bot:rep:mute'..msg.chat_id_) then
				mroan = "<b> (صٌِـــوتهٌ، صفٌاتهٌ، ضِّـــحكتّهُّ...احلْى شيٌ بالدٌنياْ)🙈😻☝️ </b>"
else 
                mroan = ''  
end
send(msg.chat_id_, msg.id_, 1, mroan, 1, 'html')
...
if text ==   'فطم'   then 
if not database:get('bot:rep:mute'..msg.chat_id_) then
				mroan = "<b> اوٌيليْ لك ٌ ضحٌكتهٌ تسوْه الدنٌيا وٌما ُبيههّ😻☝️ </b>"
else 
                mroan = ''  
end
send(msg.chat_id_, msg.id_, 1, mroan, 1, 'html')
...
if text ==   'شهد'   then 
if not database:get('bot:rep:mute'..msg.chat_id_) then
				mroan = "<b> ••• اوُٓيٌــلــيْ لكُٰ هاُي تٰٰــــاُجْ 👑 وعِــلٰم شُحٰــدهٰ الــيندٰگ بيٰهه•••😍😻☝️ </b>"
else 
                mroan = ''  
end
send(msg.chat_id_, msg.id_, 1, mroan, 1, 'html')
...
if text ==   'بوسه'   then 
if not database:get('bot:rep:mute'..msg.chat_id_) then
				mroan = "<b> خٌِـــايب گـم 😂 يريد بوسهْ وجه القرْد🐵😹😹🙌 </b>"
else 
                mroan = ''  
end
send(msg.chat_id_, msg.id_, 1, mroan, 1, 'html')
				...
				if text ==   'باي'   then 
if not database:get('bot:rep:mute'..msg.chat_id_) then
				mroan = "<b>  بٰـہٰٖاٰيٰـہٰٖاٰتٰـہٰٖ   عٰـہٰٖمٰـہٰٖرٰيٰـہٰٖ ﴿🙊💗 </b>"
else 
                mroan = ''  
end
send(msg.chat_id_, msg.id_, 1, mroan, 1, 'html')
								...
								if text ==   'جاو'   then 
if not database:get('bot:rep:mute'..msg.chat_id_) then
				mroan = "<b>  جٰـہٰٖاٰوٰاٰتٰـہٰٖ  حٰـہٰٖيٰـہٰٖاٰتٰـہٰٖيٰـہٰٖ 💙🙈</b>"
else 
                mroan = ''  
end
send(msg.chat_id_, msg.id_, 1, mroan, 1, 'html')
...
if text ==   'بوسني'   then 
if not database:get('bot:rep:mute'..msg.chat_id_) then
				mroan = "<b> مْـواحْ💋 نسخْ لصقْ ع الشفهٌْ 🙈 </b>"
else 
                mroan = ''  
end
send(msg.chat_id_, msg.id_, 1, mroan, 1, 'html')
...
if text ==   'غازلني'   then 
if not database:get('bot:rep:mute'..msg.chat_id_) then
				mroan = "<b> راح اُحـــط شِفتـِــي 💋 علـٌِ شفتٌِــك 💋 وشُُـــبَع ْ من الـ شفِـفهٌ  ضُوگ😋 راحُ اجرٰبيه عٰ لـ كيفّـي 🙀 والا  اخلــي الُجوُه فوٰگ 😹😻☝️ </b>"
else 
                mroan = ''  
end
send(msg.chat_id_, msg.id_, 1, mroan, 1, 'html')
...
if text ==   'تخليني'   then 
if not database:get('bot:rep:mute'..msg.chat_id_) then
				mroan = "<b> اٌيــــُـــــي حبيْ اخُــــليكْ عْـــِلوااا 😔 اليْوم تعْبــانْ انيَ ٌهـٰٰـٰـٰـــاكْ 🐑🐏🐑🐄🐄 اسُْــــرح بيهنْ بــسٰ ديــرْ بالكْ عليِـــ💋ــهن فدِوه موْ تصْير اْثولَ 🙊وتيــهْم😻😹😹☝️ </b>"
else 
                mroan = ''  
end
send(msg.chat_id_, msg.id_, 1, mroan, 1, 'html')
...
if text ==   '🤔🤔'   then 
if not database:get('bot:rep:mute'..msg.chat_id_) then
				mroan = "<b> الحمد لله 😔 راح تنلاص المشكله😿 بالزايد كام يفكر😂🍃 </b>"
else 
                mroan = ''  
end
send(msg.chat_id_, msg.id_, 1, mroan, 1, 'html')
...
if text ==   '😳😳'   then 
if not database:get('bot:rep:mute'..msg.chat_id_) then
				mroan = "<b> شبيك 🙀 مصدوم شنو 🙄 جديده عليك حتى تنصدم ♥️🍃 </b>"
else 
                mroan = ''  
end
send(msg.chat_id_, msg.id_, 1, mroan, 1, 'html')
...
if text ==   'فديتك'   then 
if not database:get('bot:rep:mute'..msg.chat_id_) then
				mroan = "<b> فٰـہٰٖدٰاٰكٰـہٰٖ كٰـہٰٖوٰنٰـہٰٖ وٰقٰـہٰٖوٰاٰطٰـہٰٖيٰـہٰٖ مٰـہٰٖعٰـہٰٖجٰـہٰٖوٰنٰـہٰٖ وٰزٖاٰهٰـہٰٖيٰـہٰٖ وٰلـہٰٖفٰـہٰٖاٰفٰـہٰٖوٰنٰـہٰٖ ➤|💨ֆ🌪 </b>"
else 
                mroan = ''  
end
send(msg.chat_id_, msg.id_, 1, mroan, 1, 'html')
...
if text ==   'اكلك'   then 
if not database:get('bot:rep:mute'..msg.chat_id_) then
				mroan = "<b> كٰـہٰٖوٰلـہٰٖ مٰـہٰٖاٰكٰـہٰٖوٰلـہٖ ℠⁽“ֆ🍃🌙ᴖ </b>"
else 
                mroan = ''  
end
send(msg.chat_id_, msg.id_, 1, mroan, 1, 'html')
...
if text ==   'احبكم'   then 
if not database:get('bot:rep:mute'..msg.chat_id_) then
				mroan = "<b> ٰـہٰٖدٰ يٰـہٰٖحٰـہٰٖبٰـہٰٖكٰـہٰٖ لـہٰٖتٰـہٰٖزٖحٰـہٰٖفٰـہٰٖ 💥۶ֆ⌯﴾❥ </b>"
else 
                mroan = ''  
end
send(msg.chat_id_, msg.id_, 1, mroan, 1, 'html')
...
if text ==   'احبك'   then 
if not database:get('bot:rep:mute'..msg.chat_id_) then
				mroan = "<b>يٰـہٰٖمٰـہٰٖهٰـہٰٖ اٰعٰـہٰٖشٰـہٰٖقٰـہٰٖكٰـہٰٖ ₎❉ </b>"
else 
                mroan = ''  
end
send(msg.chat_id_, msg.id_, 1, mroan, 1, 'html')
...
if not database:get('bot:rep:mute'..msg.chat_id_) then
				mroan = "<b> اٰنٰـہٰٖيٰـہٰٖ اٰكٰـہٰٖثٰـہٰٖرٰ  ⁽࿑♚  </b>"
else 
                mroan = ''  
end
send(msg.chat_id_, msg.id_, 1, mroan, 1, 'html')
...
if text ==   'لا' then
if not database:get('bot:rep:mute'..msg.chat_id_) then
				mroan = "<b> ٰٖانجٰـہٰٖبٰـہٰٖ اٰيٰـہٰٖ 💥۶ֆᵛ͢ᵎᵖ </b>"
else 
                mroan = ''  
end
send(msg.chat_id_, msg.id_, 1, mroan, 1, 'html')
...
if text ==   '😘'   then 
if not database:get('bot:rep:mute'..msg.chat_id_) then
				mroan = "<b> ٰعـہٰٖسٰـہٰٖلـہٰٖ حٰـہٰٖيٰـہٰٖاٰتٰـہٰٖيٰـہٰٖ ⁽🕸🦊↡₎℠</b>"
else 
                mroan = ''  
end
send(msg.chat_id_, msg.id_, 1, mroan, 1, 'html')
...
if text ==   '😑'   then 
if not database:get('bot:rep:mute'..msg.chat_id_) then
				mroan = "<b>  شٰـہٰٖكٰـہٰٖوٰ شٰـہٰٖبٰـہٰٖيٰـہٰٖكٰـہٰٖ ✾♛💛¡⌯﴾❥  </b>"
else 
                mroan = ''  
end
send(msg.chat_id_, msg.id_, 1, mroan, 1, 'html')
...
if text ==   '😍'   then 
if not database:get('bot:rep:mute'..msg.chat_id_) then
				mroan = "<b> شٰـہٰٖوٰفٰـہٰٖ الحٰـہٰٖبٰـہٰٖ وٰاٰنٰـہٰٖيٰـہٰٖ حٰـہٰٖدٰيٰـہٰٖقٰـہٰٖهٰـہٰٖ ₎⇣۶ֆ🐿✿ ⁞  </b>"
else 
                mroan = ''  
end
send(msg.chat_id_, msg.id_, 1, mroan, 1, 'html')
...
if text ==   'رنا'   then 
if not database:get('bot:rep:mute'..msg.chat_id_) then
				mroan = "<b> 🙄😂كلهم جبس باتو بٍْـßẳȘـﺴٍْﮧ✋️ ﭐﻧـ℘ـتـ✮๋͜‏ٓـي ٴ ͢⁽✨☻₎♤ جبس ليز </b>"
else 
                mroan = ''  
end
send(msg.chat_id_, msg.id_, 1, mroan, 1, 'html')
end
if text ==   'xxxxhtufudufjfifhfyfsyrudcsf'   then 
if not database:get('bot:rep:mute'..msg.chat_id_) then
				mroan = "<b> مٰـہٰٖطٰـہٰٖوٰرٰيٰـہٰٖ عٰـہٰٖشٰـہٰٖقٰـہٰٖ ضٰـہٰٖلـہٰٖعٰـہٰٖ اٰلـہٰٖقٰـہٰٖيٰـہٰٖصٰـہٰٖرٰ ║💙😻🙈</b>"
else 
                mroan = ''  
end
send(msg.chat_id_, msg.id_, 1, mroan, 1, 'html')
...
if text ==   'زينا'   then 
if not database:get('bot:rep:mute'..msg.chat_id_) then
				mroan = "<b> - شٰـہٰٖحٰـہٰٖلـہٰٖاٰتٰـہٰٖ. اٰسٰـہٰٖمٰـہٰٖهٰـہٰٖ ⁽🕸🦊↡₎℠ </b>"
else 
                mroan = ''  
end
send(msg.chat_id_, msg.id_, 1, mroan, 1, 'html')
...
if text ==   'شغال'   then 
if not database:get('bot:rep:mute'..msg.chat_id_) then
				mroan = "<b>  اٰيٰـہٰٖ   شٰـہٰٖغٰـہٰٖاٰلـہٰٖ ♛⇣🐰☄️₎✦ </b>"
else 
                mroan = ''  
end
send(msg.chat_id_, msg.id_, 1, mroan, 1, 'html')
...
if text ==   '😂😂'   then 
if not database:get('bot:rep:mute'..msg.chat_id_) then
				mroan = "<b> كٰـہٰٖاٰفٰـہٰٖيٰـہ  ٰٖ ضٰـہٰٖحٰـہٰٖكٰـہٰٖ ₎⌯﴾🙊💙❁ </b>"
else 
                mroan = ''  
end
send(msg.chat_id_, msg.id_, 1, mroan, 1, 'html')
...
if text ==   '🌝'   then 
if not database:get('bot:rep:mute'..msg.chat_id_) then
				mroan = "<b>  عٰـہٰٖوٰدٰ نٰـہٰٖضٰـہٰٖيٰـہٰٖفٰـہٰٖ اٰلـہٰٖوٰصٰـہٰٖخٰـہٰٖ ║♜💛⚡️₎⇣✿ ⁞  </b>"
else 
               mroan = ''  
end
send(msg.chat_id_, msg.id_, 1, mroan, 1, 'html')
end
if text ==   'cccccccccccc'   then 
if not database:get('bot:rep:mute'..msg.chat_id_) then
				mroan = "<b> اٰٰي كيـٰٰبـــــــر تُفــــــظـٰٰــــل 🌝🍃 </b>"
else 
                mroan = ''  
end
send(msg.chat_id_, msg.id_, 1, mroan, 1, 'html')
	...
	if text ==   'مروان'   then 
if not database:get('bot:rep:mute'..msg.chat_id_) then
				mroan= "<code> شُـٰٰـٰــــرايــد مُــــــٰٰـٰٰـنــه 🌚🍃 </code>"
else 
                mroan = ''  
end
send(msg.chat_id_, msg.id_, 1, mroan, 1, 'html')
...
send(msg.chat_id_, msg.id_, 1, mroan, 1, 'html')
					...
					if text ==   'مروان'   then 
if not database:get('bot:rep:mute'..msg.chat_id_) then
				mroan</b> فٰـہٰٖدٰيٰـہٰٖتٰـہٰٖهٰـہٰٖ  ⁽🔱₎ֆ﴾</b>"
else 
                mroan = ''  
end
send(msg.chat_id_, msg.id_, 1, mroan, 1, 'html')
...
✺.<b> الرابــط</b> : https://telegram.org/deactivate 
		...
		if text:match("^السورس$") or text:match("^مطور السورس$") or text:match("^ياسورس$") or  text:match("^سورس مروان$") or text:match("^اريد سورس$") then
   
   local text =  [[
<b>(اهلا بكم في السورس المميز مروان)</b> 🍃

<b>(السورس من تطوير🎣 )</b>:

																																																
<code>مروانٰ </code> : @mroan8
<code>▫️تواصــل </code> : @bnmvkbot

																																																
<b>(رابط حساب Github ):</b> 📣

- https://github.com/mroan/mroan
        ...
        if is_momod(msg.sender_user_id_, msg.chat_id_) and (text:match("^[Gg]view$") or text:match("^عدد المشاهدات$")) then
          ...
          if database:get("Bot:restart" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then
            ...
            elseif text:match("^1$") then
              ...
              run_cmd("screen -d -m ./mroan autorun")
            end
          end
